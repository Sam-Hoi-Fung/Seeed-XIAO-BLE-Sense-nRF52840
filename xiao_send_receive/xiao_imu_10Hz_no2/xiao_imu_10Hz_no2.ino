...
// BLE Service
BLEService imuService("df541fef-d2a9-42b4-a730-8e258cbc97f9"); // Custom UUID for the service

// BLE Characteristic with custom UUID
BLECharacteristic imuChar("d6b2f500-5868-4404-a2da-a38ce3b3cdd4", BLERead | BLENotify, 400); // Custom UUID for IMU data
...
void setup() {
    ...
    BLE.setDeviceName("XIAO BLE Sense no2");
    BLE.setLocalName("XIAO BLE Sense no2");
